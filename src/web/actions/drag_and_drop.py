...
class DragAndDrop(Action):
    ...
    def __init__(self, source_selector: str, target_selector: str):
        self.source_selector = source_selector
        self.target_selector = target_selector

    def perform_as(self, actor: Actor) -> None:
        return BrowseTheWeb.As(actor).drag_and_drop(self.source_selector, self.target_selector)

    @staticmethod
    def execute(source_selector: str, target_selector: str) -> "DragAndDrop":
        ...
        """
        return DragAndDrop(source_selector, target_selector)
